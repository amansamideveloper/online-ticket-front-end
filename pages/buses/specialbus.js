...
import { checkinContract, refresh, getcontractDeparture, getcontractDestination, bookingContract } from '../../actions/travelAction'
...
function Daily(props) {
    ...
    const error = props.contract.checkin?.error
    let success = props.contract.checkin?.success
    console.log(props.contract.checkin?.success)
    const booking = (e) => {
    ...
    if (props.contract.booking && success) {
                        ...
                        <div className="items-center flex flex-wrap">
                            {bookingForm && <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                                <div className="text-blueGray-400 text-center mb-3 font-bold">
                                    <small> Fill all the requirement for Special Bus</small>
                                </div>
                                <form onSubmit={booking}>
                                    <div className="relative w-full mb-3">
                                        ...
                                        />
                                        {props.errors ? <div className="text-red-500 text-center mb-3 font-bold">
                                            <small> {props.errors?.data?.fullname}</small>
                                        </div> : ''}
                                    </div>
                                    <div className="relative w-full mb-3">
                                        <label
                                        ...
                                        />
                                        {props.errors ? <div className="text-red-500 text-center mb-3 font-bold">
                                            <small> {props.errors?.data?.phonenumber}</small>
                                        </div> : ''}
                                    </div>
                                    <div className="relative w-full mb-3">
                                        <label
                            ...
                            {props.contract.checkin?.data.map((res, i) => {

                                return res.seats - res.available.length > 0 ? (
                                    <div key={i} className="w-full md:w-4/12 px-4 text-center cursor-pointer" onClick={() => selectThisbus(res)} >
                                        <div className={res._id === datafromselect?.id ? "relative flex flex-col min-w-0 break-words text-white bg-teal-500 w-full mb-8 shadow-lg rounded-lg" : "relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg"}>
                                            ...
                                            <div className="px-4 py-5 flex-auto">
                                                ...
                                                <p className="mt-2 mb-4">Taken seats {res.available.length}
                                                </p>
                                                <p className="mt-2 mb-4">available seats {res.seats - res.available.length}
                                                </p>
                                    ...
                                    <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                                        ...
                                        <form onSubmit={checkin}>
                                            ...
                                            <div className="relative w-full mb-3">
                                                ...
                                                {data?.seats ? <div className="text-red-500 text-center mb-3 font-bold">
...
export default connect(mapStateToProps, { checkinContract, refresh, bookingContract, getcontractDeparture, getcontractDestination })(Daily)
