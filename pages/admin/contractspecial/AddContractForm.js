...
// components
import { registerContract } from "actions/contractAction";
...
function AddTravelForm(props) {
    ...
    if (props.contract.success) {
        ...
        router.push('/admin/contractspecial/contract')


    }
    // console.log(props.buses.buses.success)
                            ...
                            <div className="flex flex-wrap">
                                <div className="w-full lg:w-12/12 px-4">
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        {buses ? <select onChange={e => setBus(e.target.value)} className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
...
// }
export default connect(mapStateToProps, { registerContract, clear, getContractBuses, isAdmin })(AddTravelForm)