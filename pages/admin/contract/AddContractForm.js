...
function AddTravelForm(props) {
    ...
    const Submit = (e) => {
        ...
        props.registerTravel(data)
        if (props.travels.travels) {
            router.push('/admin/contract/contract')
        }
                            ...
                            <div className="flex flex-wrap">
                                <div className="w-full lg:w-12/12 px-4">
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        {props.buses.buses ? <select onChange={e => setBus(e.target.value)} className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                            {props.buses.buses.success.map((b) => (
...
// }
export default connect(mapStateToProps, { registerTravel, getBuses, setFalse, clear, isAdmin })(AddTravelForm)